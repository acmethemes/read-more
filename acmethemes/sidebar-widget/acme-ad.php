...
if ( ! class_exists( 'read_more_ad_widget' ) ) :
    ...
    class read_more_ad_widget extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_title' ) ); ?>"><?php _e( 'Title:', 'read-more' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'read_more_ad_title' ) ); ?>" type="text" value="<?php echo esc_attr( $read_more_ad_title ); ?>" />
            </p>
            <h4 class="accordion-toggle"><?php _e( 'Advertisement Image', 'read-more' ); ?></h4>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_image' ) ); ?>">
                ...
                <input type="text" class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'read_more_ad_image' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_image' ) ); ?>" value="<?php echo esc_url( $read_more_ad_image ); ?>" />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_img_alt' ) ); ?>"><?php _e( 'Alt Text:', 'read-more' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_img_alt' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'read_more_ad_img_alt' ) ); ?>" type="text" value="<?php echo esc_attr( $read_more_ad_img_alt ); ?>" />
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_link' ) ); ?>"><?php _e( 'Link URL:', 'read-more' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'read_more_ad_link' ) ); ?>" type="text" value="<?php echo esc_attr( $read_more_ad_link ); ?>" />
            </p>
            <p>
                <input id="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_new_window' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'read_more_ad_new_window' ) ); ?>" type="checkbox" <?php checked( 1 == $read_more_ad_new_window ? $instance['read_more_ad_new_window'] : 0); ?> />
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_ad_new_window' ) ); ?>"><?php _e( 'Open in new window', 'read-more' ); ?></label>
            </p>
            <hr />
            <?php
        }
