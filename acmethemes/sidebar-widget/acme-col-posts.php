...
if ( ! class_exists( 'Read_more_posts_col' ) ) {
    ...
    class Read_more_posts_col extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_cat_id' ) ); ?>"><?php _e('Select Category', 'read-more'); ?></label>
                <?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'post_number' ) ); ?>"><?php _e( 'Post Number', 'read-more' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>"><?php _e( 'Column Number', 'read-more' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_post_col_image_layout' ) ); ?>">
                    <?php _e( 'Post Image', 'read-more' ); ?>
                </label>
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'read_more_post_col_image_layout' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'read_more_post_col_image_layout' ) ); ?>">
                    <?php
                    foreach( $choices as $key => $read_more_column_array ){
                        echo ' <option value="'.$key.'"'.selected( esc_attr( $read_more_post_col_image_layout ), $key, 0).'>'.$read_more_column_array.'</option>';
                    }
                    ?>
                </select>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'read_more_post_col_content_length' ) ); ?>"><?php _e( 'Post Content Length', 'read-more' ); ?>:</label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'read_more_post_col_content_length' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'read_more_post_col_content_length' ) ); ?>" type="number" value="<?php echo esc_attr( $read_more_post_col_content_length ); ?>" />
            </p>
            <p>
