                ...
                <td>
                    ...
                    foreach ($read_more_sidebar_layout_options as $field) {
                        ...
                        <div class="hide-radio radio-image-wrapper" style="float:left; margin-right:30px;">
                            <input id="<?php echo esc_attr( $field['value'] ); ?>" type="radio" name="read_more_sidebar_layout" value="<?php echo esc_attr( $field['value'] ); ?>" <?php checked( $field['value'], $read_more_sidebar_layout ); ?>/>
...
if ( !function_exists('read_more_featured_video_callback') ) :
    function read_more_featured_video_callback(){
        ...
        <table class="form-table page-meta-box">
            ...
            <tr>
                <td>
                    <input id="read_more_replace_featured_image" type="checkbox" name="read_more_replace_featured_image" <?php checked( 1, esc_attr( $read_more_replace_featured_image ) ); ?> />
            ...
            <tr>
                <td>
                    <input id="read_more_video_autoplay" type="checkbox" name="read_more_video_autoplay" <?php checked( 1, esc_attr( $read_more_video_autoplay ) ); ?> />
